...
The dummy-only docs page at `/docs/mcp` shows the MCP URL. Signed-in users can mint a real test Bearer for Seed MCP App against Studio Workspace for local curl. It is not the product.
