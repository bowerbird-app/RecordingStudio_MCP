...
class RecordingStudioMcpTest < Minitest::Test
  ...
  def test_gemspec_pins_live_addons
    ...
    assert_includes gemspec, 'spec.add_dependency "recording_studio_oauth", ">= 0.1.1"'
  ...
  def test_dummy_gemfile_pins_live_github_tags
    ...
    assert_includes gemfile, 'github: "bowerbird-app/RecordingStudio_Oauth", branch: "cursor/oauth-mcp-resource-identity-21f3"'
